...
public class ObjectMultistackDemo {
    public static void main(String[] args) {
        ...
        ValueWrapper year = new ValueWrapper(Integer.valueOf(2000)); multistack.push("year", year);
        ValueWrapper price = new ValueWrapper(200.51); multistack.push("price", price);
